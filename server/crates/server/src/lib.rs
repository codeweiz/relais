// relais-server: HTTP and WebSocket server for Relais
//
// Implements the Axum-based web server with REST API endpoints,
// WebSocket transport for real-time terminal I/O,
// authentication, rate limiting, and structured access logging.
...
/// Start the Relais HTTP/WebSocket server.
///

//! Structured access logging and tracing setup for Relais server.
//!
//! Provides:
...
/// - **File**: access logs written to `~/.relais/logs/access.jsonl` using a rolling appender
///
        ...
        if let Err(e) = std::fs::create_dir_all(log_dir) {
            ...
            Some(
                fmt::layer()
                    ...
                    .with_filter(EnvFilter::new("relais_server::logging=info")),
            )
        }
    } else {
        None
